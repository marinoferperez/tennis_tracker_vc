...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{Sistema de Detección y Seguimiento Automático de Jugadores y Pelota en Partidos de Tenis en Tiempo Real}

\author{Marino Fernández Pérez\\ 
%Institution1\\
...
\and
Pau Bover Femenias\\
{\tt\small paubovel@correo.ugr.es}
\and
Gabriele Ruggeri\\
